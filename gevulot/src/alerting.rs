// Copied from https://github.com/succinctlabs/rsp/blob/881ba190e758e01e72399df462ac99864930ddb0/crates/executor/host/src/alerting.rs.
...
impl AlertingClient {
  ...
  pub async fn send_alert(&self, summary: String) {
    ...
    match self
      .client
      .post(format!("{}/enqueue", PAGER_DUTY_ENDPOINT))
      .json(&alert)
      .send()
      .await
    {
