...
- SuccintLab's https://github.com/succinctlabs/rsp[RSP]
- Risc0's https://github.com/boundless-xyz/zeth[Zeth] - before the whole codebase was destroyed in https://github.com/boundless-xyz/zeth/pull/170[#170].
...
IMPORTANT: In order to compile guest, you need ZisK https://github.com/zenith-network/zisk-container[binaries].
