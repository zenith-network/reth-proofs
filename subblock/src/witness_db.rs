// Copied from https://github.com/paradigmxyz/reth/blob/373576704bea39532e806daecb5afad7972178c5/crates/stateless/src/witness_db.rs,
// as `WitnessDatabase` is not publicly exposed in reth-stateless crate.
  ...
  T: StatelessTrie,
{
  ...
  fn code_by_hash(&mut self, code_hash: B256) -> Result<Bytecode, Self::Error> {
    self
      ...
      .get(&code_hash)
      .cloned()
      .ok_or_else(|| ProviderError::TrieWitnessError(format!("bytecode for {code_hash} not found")))
  }
